...
shell-connect-arm-discovery-failed = Could not discover the Azure Resource Manager context for this account ({ $message }). Database and container commands will use the Cosmos DB data plane. Reconnect with --subscription, --resource-group, and --account only if you need ARM-backed resource management.
...
error-arm-context-incomplete = Provide subscription and resource group together to use an explicit Azure Resource Manager account context. The account name is inferred from the endpoint unless --account is provided.
...
command-connect-description-subscription = Azure subscription ID for ARM database and container operations.
command-connect-description-resource-group = Azure resource group name for ARM database and container operations.
command-connect-description-account = Cosmos DB account name for ARM database and container operations. Defaults to the account name inferred from the endpoint.
...
help-ConnectAccount = Cosmos DB account name for ARM database and container operations at startup.
