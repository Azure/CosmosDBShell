...
command-udf-description = Manages user-defined functions on a container via list, show, exists, create, and delete subcommands.
command-udf-description-subcommand = The action to perform: list, show, exists, create, or delete.
...
command-udf-error-missing_subcommand = Missing subcommand. Use one of: list, show, exists, create, delete.
command-udf-error-invalid_subcommand = Unknown subcommand '{ $subcommand }'. Use one of: list, show, exists, create, delete.
...
command-trigger-description = Manages triggers on a container via list, show, exists, create, and delete subcommands.
command-trigger-description-subcommand = The action to perform: list, show, exists, create, or delete.
...
command-trigger-error-missing_subcommand = Missing subcommand. Use one of: list, show, exists, create, delete.
command-trigger-error-invalid_subcommand = Unknown subcommand '{ $subcommand }'. Use one of: list, show, exists, create, delete.
