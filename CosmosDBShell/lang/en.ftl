...
command-theme-description-action = What to do: 'list', 'show', 'use', 'load', 'save', or 'reload' (default lists the active theme).
command-theme-description-name = Theme name (for show/use/save) or path to a TOML file (for load).
command-theme-description-path = Optional path. For 'save' the file path to write (default: ~/.cosmosdbshell/themes/<name>.toml). For 'load' the TOML file to load.
