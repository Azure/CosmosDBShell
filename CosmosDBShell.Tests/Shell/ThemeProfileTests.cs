...
public class ThemeProfileTests
{
    ...
    public void Profiles_UseOnlyAnsi16ColorsAndAllowedModifiers(string name)
    {
        ...
        var slots = new (string Slot, string Value)[]
        {
            ...
            (nameof(profile.StringColor), profile.StringColor),
            (nameof(profile.NumberColor), profile.NumberColor),
            (nameof(profile.BooleanColor), profile.BooleanColor),
            (nameof(profile.NullColor), profile.NullColor),
            (nameof(profile.StringEscapeColor), profile.StringEscapeColor),
